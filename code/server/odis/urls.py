...
urlpatterns = [
    ...
    path("node/connections/<uuid:id>/<str:action>/", NodeConnections.as_view(), name="odis-node-connection-action"),
    path("node/connections/<uuid:id>/", NodeConnections.as_view(), name="odis-node-connection"),
